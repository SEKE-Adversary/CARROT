...
if __name__ == "__main__":
    ...
    #atk = Attacker(poj, symtab, model, word2vec)
    #atk.attack_all(40, 50)

    #atk = InsAttacker(poj, instab, model, word2vec)
    #atk.attack_all(40, 20)

    atk = AttackerRandom(poj, symtab, model, word2vec)
    atk.attack_all(100)

    #atk = InsAttackerRandom(poj, instab, model, word2vec)
    #atk.attack_all(20)