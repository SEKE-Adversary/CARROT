...
class CODECHEF_AST_GRAPH(object):
    
    def __init__(self, path='../data_defect/codechef_ast_graph.pkl.gz', vocab_size=3000,
...
if __name__ == "__main__":
    ...
    cc = CODECHEF_AST_GRAPH(path="../data_defect/codechef_ast_graph.pkl.gz")
