...
def trainEpochs(epochs, training_set, valid_set, device,
    ...
    while True:
        ...
        if batch['new_epoch']:
            ...
            classifier.model.save_pretrained(os.path.join(saving_path, str(epoch)))
            classifier.tokenizer.save_pretrained(os.path.join(saving_path, str(epoch)))
            ...
            i = 0
            print_loss_total = 0
            print('start training epoch ' + str(epoch + 1) + '....', flush=True)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--save_dir', type=str, default="../model_defect/codebert")
