# -*- coding: utf-8 -*-
"""
Created on Fri Jun 25 18:50:43 2021
...
if __name__ == "__main__":
    ...
    src_path = "../data_clone/oj.pkl.gz"
    tgt_path = "../data_clone/oj_ast_graph.pkl.gz"
    ...
    dataset = {'tr': {"pair": x_tr, "label": y_tr, "node": node_tr,
                      "begin": begin_tr, "end": end_tr, "raw": raw_tr},
               'te': {"pair": x_te, "label": y_te, "node": node_te,
                      "begin": begin_te, "end": end_te, "raw": raw_te},
               'idx2node': idx2node, 'node2idx': node2idx}
